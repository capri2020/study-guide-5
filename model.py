...
class Brand(db.Model):
    ...
    brand_id = db.Column(db.String(10), primary_key=True)
    ...
    def __ref__(self):
        ...
        return "<Brand id={} name={} founded={} headquarters={} discontinued={}>".format(
...
class Model(db.Model):
    ...
    def __ref__(self):
        ...
        return "<Model id={} year={} name={}>".format(self.model_id, self.year, self.name)   
