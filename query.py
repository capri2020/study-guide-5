...
def get_model_info(year):
    ...
    if models:
        ...
        for item in models:
            print('\nModel name:'+ item.name + ' Brand name:'+ item.brand.name + 
            ' Headquarters:' + item.brand.headquarters)
    else:
...
def get_models_between(start_year, end_year):
    ...
    all_models = Model.query.filter(Model.year >= start_year,
